 ...
 * 
 */
@WebServiceClient(name = "CalculadoraImplService", targetNamespace = "http://example.org/", wsdlLocation = "http://localhost:5000/jaxws/calculadora?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORAIMPLSERVICE_QNAME = new QName("http://example.org/", "CalculadoraImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:5000/jaxws/calculadora?wsdl");
    ...
    public ICalculadora getCalculadoraImplPort() {
        return super.getPort(new QName("http://example.org/", "CalculadoraImplPort"), ICalculadora.class);
    }
    ...
    public ICalculadora getCalculadoraImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://example.org/", "CalculadoraImplPort"), ICalculadora.class, features);
    }
